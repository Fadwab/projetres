...
@Component({
  selector: 'app-reservation-event-day',
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: './reservation-event-day.component.html',
 
})
export class ReservationEventDayComponent implements OnInit {
