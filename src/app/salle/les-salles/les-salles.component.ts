...
@Component({
  selector: 'app-les-salles',
  templateUrl: './les-salles.component.html',
  styleUrls: ['./les-salles.component.css'],
  providers:[SalleService]
})
export class LesSallesComponent implements OnInit {
  displayedColumns = ['salle_id', 'nom', 'etage', 'bloc', 'capacite','equipement'];
